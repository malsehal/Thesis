#!/usr/bin/env python3
"""
Runs event-driven spectrum simulation for the MEDIUM demand scenario across all feasible architectures.
Saves results to results/medium_demand/event_driven_results_medium.csv and generates trade space plots.
"""
import os
import csv
...
RESULTS_DIR = "results/medium_demand"
RESULTS_CSV = os.path.join(RESULTS_DIR, "event_driven_results_medium.csv")
PLOT_SCRIPT = "plot_medium_demand_trade_space.py"

os.makedirs(RESULTS_DIR, exist_ok=True)

# Prepare environment and demand
