#!/usr/bin/env python3
"""
Runs event-driven spectrum simulation for the LOW demand scenario across all feasible architectures.
Saves results to results/low_demand/event_driven_results_low.csv and generates trade space plots.
"""
import os
import csv
...
RESULTS_DIR = "results/low_demand"
RESULTS_CSV = os.path.join(RESULTS_DIR, "event_driven_results_low.csv")
PLOT_SCRIPT = "plot_low_demand_trade_space.py"
