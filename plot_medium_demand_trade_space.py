"""
Visualize trade space results for the medium demand scenario.
"""
import os
import pandas as pd
...
RESULTS_FILE = "results/medium_demand/event_driven_results_medium.csv"
PLOT_DIR = "results/medium_demand/plots"
...
def plot_trade_space(df, x_metric, y_metric, color_by=None, save_path=None, html_path=None):
    ...
    fig = px.scatter(
        ...
        title=f"Medium Demand: {format_metric_name(x_metric)} vs {format_metric_name(y_metric)}",
...
# --- Additional exploratory plots for deeper analysis (pairwise matrix & parallel coordinates) ---
